...
public class Fraction implements Comparable<Fraction> {
    ...
    public Fraction(long n, long d) throws Exception {
        ...
        if (d == 0) {
            Exception e = new Exception("Can't have a denominator of 0.");
            throw e;
        }
    ...
    public Fraction fractionPlus(Fraction rhs) throws Exception {
    ...
    public Fraction fractionMinus(Fraction rhs) throws Exception {
        //multiply the denominators to get a common denominator
        long commonDenominator = _denominator * rhs._denominator;
    ...
    public Fraction fractionTimes(Fraction rhs) throws Exception {
    ...
    public Fraction fractionDividedBy(Fraction rhs) throws Exception {
    ...
    public Fraction fractionReciprocal() throws Exception {
